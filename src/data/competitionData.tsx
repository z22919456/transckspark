export const competitionEnglishData = {
  ...
  importantDates: [
    ...
    },
    {
      ...
      time: 'Apr 7, 2023 to Jun 30, 2023',
    },
    {
      title: 'Design Forum',
      time: 'April - May 2023',
  ...
  theme: 'Conceptual Design Competition for Heart of the Capital: A Vision for Transforming Chiang Kai-Shek Memorial Hall',
  statements: [
    "Chiang Kai-Shek Memorial Hall (CKS Memorial Hall), located in the middle of Taipei City, is an important public space in Taiwan's present-day capital. It is also a site that draws the hearts of the people together, and where their hopes and dreams manifest. The sights and sites of CKS Memorial Hall and its surroundings have become palimpsests of history that tell complex and diverse narratives. The CKS Memorial Hall, which has become an integral part of the life of each historical subject that crosses its path, is a focal point of myriad urban lifestyles and signification, simultaneously being a symbol of authoritarianism, internal strife, day-to-day life, civil society, political and social movements, as well as art, culture, and leisure.",
...
export const competitionData = {
  ...
  importantDates: [
    ...
    { title: '成果展覽', time: '2023.4.7—2023.6.30' },
    { title: '設計成果論壇', time: '2023.4月—5月' },
  ],
  ...
  statements: [ // 活動宣言
    ...
    '有鑒近年不斷生發的轉型正義、常民生活的明日願景、首都意象等思辨，不僅反應了臺灣市民社會多元辯證的活力，也挑戰了空間專業者如何在創造當代生活與未來都市願景時，重思生發於十九、二十世紀的威權政治場域空間原型，甚而找出首都核心區如何走出既有威權象徵與統理思維結構的空間再現形式，藉以創造市民公共生活場域樣態的可能性。',
  ...
  format: {
    student: [
      ...
      '決審：針對初審交件內容加強、增補之 3 張A1 圖面或 6 分鐘內影像，評選時需準備口頭簡報 15 分鐘。',
    ...
    open: [
      ...
      '決審：針對初審內容加強、增補之 3-5 張A1 圖面，或 6 分鐘內影像，兩者擇一，皆繳交亦可。評選時需準備口頭簡報 15 分鐘。',
      '評審推薦優秀作品前五名：於成果展覽時繳交一個 2mx2mx2m 為限的模型或其他多元媒材作品。',
    ],
  },
  award: {
    student: ['初選入圍 15 名，每組頒發新台幣 15 萬元。入圍團隊中，再經決選選出評審推薦優秀作品5 名，每組頒發新台幣 30 萬元（含作品材料製作費），所有入圍及推薦優秀作品將展出於後續展覽。'],
    open: ['初選入圍 15 名，每組頒發新台幣 15 萬元。入圍團隊中，再經決選選出評審推薦優秀作品 5 名，每組頒發新台幣 30 萬元（含作品材料製作費），所有入圍及推薦優秀作品將展出於後續展覽。'],
  },
  criteria: {
    first: ['設計議題的回應'],
    finals: [
