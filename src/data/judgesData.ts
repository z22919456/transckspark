...
export const finalJudges = [
  ...
  },
  {
    ...
    title: '國家文化藝術基金會董事長',
    engName: 'Mun-Lee Lin',
    information: '現任財團法人國家文化藝術基金會董事長、國立台北教育大學藝術與造形設計學系名譽教授。日本東京大學教育學博士。長期投身於藝術教育工作外，於歷任台北市立美術館館長、財團法人國家文化藝術基金會董事長及國立故宮博物院院長等職務期間，持續深耕台灣美術史研究、國際性策展以及企業參與藝術等領域。2011年於長期任教之國立台北教育大學爭取「北師美術館」的成立，並在「新形態美術館」的理念下，推動多項跨領域與實驗性的展演計畫，以及具開創性之文化交流活動。',
    image: '/images/judge/林曼麗委員.jpg',
  },
  {
    id: 4,
    name: '林靜娟',
    title: '國立台北科技大學專任副教授、成功大學建築系兼任副教授',
