      ...
      <div className="px-5">
        ...
        <Section id="about" >
          ...
          <div className="w-full relative aspect-[1.54] my-5">
            <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/about/04.jpg`} layout="fill" objectFit='contain' />
          </div>
        </Section>
        <Section id="base" >
          ...
          <div className="flex flex-wrap md:flex-nowrap md:space-x-5">
            <div className="w-full">
              <div className="w-full relative aspect-[1.54] my-5">
                <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/about/01.jpg`} layout="fill" objectFit='contain' alt="中正紀念堂園區在1903年後（日治時期間），曾是台灣步兵第一聯隊駐紮地。（中央研究院臺灣史研究所典藏、引用自開放博物館）" />
              </div>
              <small className="text-xs text-default/50 leading-[1]">中正紀念堂園區在1903年後（日治時期間），曾是台灣步兵第一聯隊駐紮地。（中央研究院臺灣史研究所典藏、引用自開放博物館）</small>
            </div>
            <div className="w-full">
              <div className="w-full relative aspect-[1.54] my-5">
                <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/images/about/02.png`} layout="fill" objectFit='contain' alt="原訂興建於今日中正紀念堂基地上雙塔型商業中心（《臺北畫刊》第67期，李乾朗繪製）" />
              </div>
        ...
        <Section id="event" >
          ...
          <div className="text-center">
            ...
            <p>2007</p><p>中正紀念堂改名為「台灣民主紀念館」、 牌樓「大中至正」改為「自由廣場」；文建會公告指定為國定古蹟「台灣民主紀念園區」，範圍包含臺灣民主紀念館、民主大道、民主廣場及正面牌樓</p><Divider />
