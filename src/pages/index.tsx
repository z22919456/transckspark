  ...
  return (
    <>
      ...
      <div className="about">
        ...
        <div className="px-5">
          <ScrollNav>
            <ScrollNavLink to="exhibition">展覽資訊</ScrollNavLink>
            <ScrollNavLink to="about">活動緣起</ScrollNavLink>
            <ScrollNavLink to="base">中正紀念堂基地脈絡</ScrollNavLink>
            <ScrollNavLink to="event">中正紀念堂大事記</ScrollNavLink>
            <ScrollNavLink to="meaning">轉型的意義</ScrollNavLink>
            <ScrollNavLink to="workgroup">工作團隊</ScrollNavLink>
          </ScrollNav>
          <Section id="exhibition">
            ...
            <h3 className="py-8 text-xl text-center">作品專場導覽</h3>
            <div className="flex flex-wrap gap-y-5">
              <div className="w-full text-center sm:w-1/3 md:w-full lg:w-1/3">
                <p className="text-lg font-bold">10 / 14 (六)</p>
                <p>上午10:00 ~ 11:00</p>
                <p>下午15:00 ~ 16:00</p>
              </div>
              <div className="w-full text-center sm:w-1/3 md:w-full lg:w-1/3">
                <p className="text-lg font-bold">10 / 28 (六)</p>
                <p>上午10:00 ~ 11:00</p>
                <p>下午15:00 ~ 16:00</p>
              </div>
              <div className="w-full text-center sm:w-1/3 md:w-full lg:w-1/3">
            ...
            <div className="mt-6 text-center">
              <a
                ...
                href="https://forms.gle/ge6vXHo7cXa79XGB6"
              >
                報名傳送門
              </a>
              <p>
            ...
            <h3 className="py-8 text-xl text-center">展覽資訊</h3>
            <p>
              <b>展覽日期</b>｜2023/10/10 ~ 12/17
            </p>
            <p>
              <b>展覽地點</b>｜中正紀念堂中央通廊（臺北市中正區中山南路21號）
            </p>
            <p>
              <b>開放時間</b>｜週一至週日09:00 ~ 18:00
            </p>
          </Section>
          <Section id="about">
            <h2 className="py-12 text-center">
            ...
            <p>
              首都之心，城中轉正：中正紀念堂園區新願景概念競圖，由台灣現代建築學會、中華民國都市設計學會、中華民國景觀學會國內三大空間規劃設計專業學會共同發起。透過競圖徵件，鼓勵社會將論述具象化；經由公眾參與活動，促進社會溝通。此競圖與系列活動，以
              「公共參與」
              為理念及方法，在嚴謹公平的程序中，聚焦規劃專業，由下而上動員空間專業界與社會大眾，激發想像力和創造力，參與都市公共空間改造過程。競圖徵件期間，搭配系列公共論壇、講座、工作坊、成果展覽，期待打開更多的對話場合、帶動社會進一步討論，從文字進展到概念，從論述具象為圖面，凝聚社會共識，推動轉型正義的空間工程。
            </p>
            <div className="w-full relative aspect-[1.54] mt-5">
              <Image
                ...
                layout="fill"
                objectFit="contain"
                alt="活動主視覺，設計：永真急制 Workshop"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
            </div>
            <p className="small text-default/50">
          ...
          <Section id="base">
            ...
            <div className="w-full relative aspect-[1.54] mt-5">
              <Image
                ...
                layout="fill"
                objectFit="contain"
                alt="中正紀念堂園區在1903年後（日治時期間），曾是台灣步兵第一聯隊駐紮地。（中央研究院臺灣史研究所典藏、引用自開放博物館）"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
            </div>
            <p className="small text-default/50">
          ...
          <Section id="event">
            ...
            <div className="text-center">
              ...
              <Divider />
              <p>1976.07.07</p>
              <p>決議錄取和睦建築師事務所楊卓成建築師之設計</p>
              <Divider />
              <p>1976.10.31</p>
              <p>舉行紀念堂破土典禮</p>
              <Divider />
              <p>1977.12.01</p>
              <p>中正紀念堂正式動工，結構部分工程先行開工</p>
              <Divider />
              <p>1978.07.12</p>
              <p>
              ...
              <Divider />
              <p>1979.01.11-1980.03.20</p>
              <p>正面牌樓、側牌樓、迴廊、角亭工程</p>
              <Divider />
              <p>1980.03.31</p>
              <p>中正紀念堂籌建竣工</p>
              <Divider />
              ...
              <p>
                中正紀念堂改名為「台灣民主紀念館」、
                牌樓「大中至正」改為「自由廣場」；文建會公告指定為國定古蹟「台灣民主紀念園區」，範圍包含台灣民主紀念館、民主大道、民主廣場及正面牌樓
              </p>
              <Divider />
              <p>2008</p>
              <p>
              ...
              <Divider />
              <p>2008.01.01-02.10</p>
              <p>
                舉行「民主開門
                自由風吹」開幕典禮，首次在銅像大廳辦展，以解構威權空間為主題，展示風箏、學運和社運照片等
              </p>
              <Divider />
              <p>2017</p>
              <p>
          ...
          <Section id="workgroup">
            ...
            <p>
              <b>美術及網站製作 ｜</b> J.C、Arthur Li
            </p>
            <p>
              <b>主視覺構成 ｜</b> 永真急制Workshop
            </p>
            <p>
              <b>印刷 ｜</b> 博創印藝文化事業
            </p>
