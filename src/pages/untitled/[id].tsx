...
function WorkPage({
  ...
  return (
    <>
      <SEO title={`${pageInformation.Title}｜網路預展 Untitled`} description={pageInformation['簡介']} />
      <div className="online-exhibition">
        ...
        <div className="px-5">
          ...
          <div className="flex items-end justify-between">
            ...
            <PaginationButton nextPage={nextPage ? `/untitled/${nextPage}` : ''} prevPage={prevPage ? `/untitled/${prevPage}` : ''} />
          </div>
        </div>
      </div>
    </>
