  ...
  return (
    <Card>
      ...
      <div className="relative my-5 aspect-video">
        <Image placeholder="blur" blurDataURL={placeholder} src={work.cover.url} layout="fill" objectFit="cover" alt={work.cover.url ? work.Title : '圖檔太大'} sizes="(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 25vw, 25vw" />
      </div>
