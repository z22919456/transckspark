...
function Footer({ }: Props) {
  return (
    <div className="absolute bottom-0 left-0 w-full lg:h-24 md:h-48 h-72 bg-footer/95">

      {/* lg */}
      {/* <div className="items-center justify-center hidden h-full py-2 my-auto xl:flex">
      ...
      {/* md */}
      <div className="items-center justify-center hidden h-full py-2 my-auto md:flex xl:hidden">
      ...
      {/* sm */}
      <div className="flex flex-wrap items-center justify-center h-full my-auto md:hidden xl:flex">

        <div className="flex items-center justify-between w-full h-24 p-5 border-r xl:w-1/3 border-default">
          <p className="w-2/5 h-full px-5 text-center border-r border-default">
            <small>
              中正紀念堂園區
              <br />
              新願景概念競圖小組
          ...
          <div className="flex items-center w-3/5 px-5 space-x-5">
            <a href="mail:info@vipassanacreative.com">
              <small>info@vipassanacreative.com</small>
            </a>
            <Link href="/">
        ...
        <div className="flex items-center justify-between w-full h-24 p-5 border-r xl:w-1/3 border-default">
          <div className="flex items-center justify-center w-2/5 h-full px-5 text-center border-r border-default">
            <Link href="/">
              <small>
                隱私權政策
              </small>
        ...
        <div className="flex w-full h-24 py-5 xl:w-1/3 ">
          <div className="flex items-center justify-center w-2/5 h-full px-5 space-x-5 border-r border-default">
            <p><small>統籌單位</small></p>
            <PlanningIcon />
          </div>
          <div className="flex items-center w-3/5 px-5 space-x-5">
