  ...
  return (
    <Card id={`${final ? 'final' : 'first'}-${id}`}>
      ...
      <div className="relative my-5 aspect-video">
        <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}${image}`} layout="fill" objectFit="cover" alt={name} sizes="(max-width:1024px) 25vw, (maw-width:768px) 50vw, (max-width: 640) 100vw, 50vw" />
      </div>
