  ...
  return (
    <Card>
      ...
      <div className="relative my-5 aspect-video">
        <Image placeholder="blur" blurDataURL="/image_loading.jpg" src={information.cover.url} layout="fill" objectFit="cover" alt={information.Title} sizes="(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 25vw, 25vw" />
      </div>
